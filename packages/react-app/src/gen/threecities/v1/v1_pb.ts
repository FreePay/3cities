...
export class CheckoutSettings extends Message<CheckoutSettings> {
  ...
  proposedPaymentPaymentMode: {
    /**
     * Big-endian binary encoding of payment logical asset amount. Deserialized as CheckoutSettings.proposedPayment.paymentMode.logicalAssetAmount
     *
...
export class CheckoutSettings_PayWhatYouWant extends Message<CheckoutSettings_PayWhatYouWant> {
  ...
  /**
   * optional. Big-endian binary encoding of suggested payment logical asset amounts. Since this is "pay what you want" mode, these amounts are only suggested to the sender and not required. Deserialized as CheckoutSettings.proposedPayment.paymentMode.payWhatYouWant.suggestedLogicalAssetAmounts
   *
