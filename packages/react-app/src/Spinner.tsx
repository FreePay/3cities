...
type SpinnerProps = {
  ...
  speed?: "slow" | "fast"; // defaults to "fast"
}

export function Spinner({ containerClassName, spinnerClassName, speed }: SpinnerProps) {
  // great collection of svg spinners: https://github.com/n3r4zzurr0/svg-spinners
  return <span className={containerClassName}>
    <svg role="status" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={`${spinnerClassName || ''} ${speed === "slow" ? 'animate-spin' : 'animate-spin-fast'}`}>
