const primaryColor = '#3b82f6'; // this color is blue-500. We chose this as the independent variable primary color just because we like it. All other colors are calculated from primaryColor.
...
const primaryColorDarker = '#2563eb'; // this color is blue-600
const secondaryColorDarker = '#9333ea'; // this color is purple-600
const tertiaryColorDarker = '#e11d48'; // this color is rose-600
const quaternaryColorDarker = '#f59e0b'; // this color is amber-500

// For lighter variants, we use the next shade down in tailwind's colors:
const primaryColorLighter = '#60a5fa'; // this color is blue-400
const secondaryColorLighter = '#c084fc'; // this color is purple-400
const tertiaryColorLighter = '#fb7185'; // this color is rose-400
const quaternaryColorLighter = '#fcd34d'; // this color is amber-300
