...
export const About: React.FC = () => {
  return (<div className="mt-8 text-left max-w-2xl mx-auto">
    ...
    <p className="text-xl mb-4">
      3cities lets you request money from anybody in the world. It&apos;s fast and free.
    </p>
    <p className="text-xl mb-4">
       3cities is like Venmo or Cash App, but a website and no sign-up needed ever.
    </p>
    <p className="text-xl mb-4">
      Soon, you&apos;ll be able to use 3cities to request money with only an email address, phone number, or Facebook.
    </p>
    <p className="text-xl mb-4">
      But for the moment, you need a crypto address to request money (no need to connect wallet).
    </p>
    <h1 className="text-3xl mb-4 mt-16">3cities explanation for crypto experts</h1>
    <p className="text-xl mb-4">
